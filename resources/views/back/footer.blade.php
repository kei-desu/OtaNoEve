...
<footer class="bg-dark text-center text-lg-start text-white">
    ...
    <div class="row mt-4">
        ...
        <h5 class="text-uppercase">See other events</h5>

        <ul class="list-unstyled mb-0">
            <li>
            <a href="#!" class="text-white"><i class="fas fa-book fa-fw fa-sm me-2"></i>Best</a>
            </li>
            <li>
            <a href="#!" class="text-white"><i class="fas fa-book fa-fw fa-sm me-2"></i>All events</a>
            </li>
            <li>
            <a href="#!" class="text-white"><i class="fas fa-user-edit fa-fw fa-sm me-2"></i>All category</a>
            </li>
        </ul>
        </div>
        <!--Grid column-->
        ...
        <ul class="list-unstyled">
            <li>
            <a href="#!" class="text-white">Tokyo Shinjuku</a>
            </li>
            <li>
            <a href="#!" class="text-white">123 Street</a>
            </li>
            <li>
            <a href="#!" class="text-white">4567 West</a>
            </li>
            <li>
            <a href="#!" class="text-white"><i class="fas fa-briefcase fa-fw fa-sm me-2"></i>Send us a message</a>
            </li>
        </ul>
        </div>
        <!--Grid column-->
        ...
        <ul class="list-unstyled">
            ...
            <li>
            <a href="#!" class="text-white"><i class="fas fa-envelope fa-fw fa-sm me-2"></i>Info</a>
            </li>
        </ul>
        </div>
        <!--Grid column-->
    ...
    © 2023 Copyright:
    <a class="text-white" href="/">OtaNoEve.com</a>
    </div>
    <!-- Copyright -->
</footer>
